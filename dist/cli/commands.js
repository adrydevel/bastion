...
// network and no key.
const DEMO_CASSETTE = join(dirname(fileURLToPath(import.meta.url)), "..", "..", "examples", "demo-cassette.json");
export function buildProgram() {
    ...
    program
        ...
        const result = await replayCassette(cassette, opts.live ? { llmFor: () => resolveProvider(cassette.config.provider) } : {});
