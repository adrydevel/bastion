...
import { inputHashOf } from "./cassette.js";
...
export async function replayCassette(cassette, opts = {}) {
    const checks = [];
    ...
    const llmFor = opts.llmFor ?? ((agent) => new ReplayDeck(cassette.exchanges).for(agent));
